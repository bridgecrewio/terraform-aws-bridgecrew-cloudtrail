...
1. If a KMS key is associated with this CloudTrail, update the key policy to allow Bridgecrew to decrypt.  For example:
...
- [terraform-aws-bridgecrew-cloudtrail](https://github.com/bridgecrewio/terraform-aws-bridgecrew-cloudtrail)

## Help

**Got a question?**

File a GitHub [issue](https://github.com/bridgecrewio/terraform-aws-bridgecrew-cloudtrail/issues).

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://github.com/bridgecrewio/terraform-aws-bridgecrew-cloudtrail/issues) to report any bugs or file feature requests.
